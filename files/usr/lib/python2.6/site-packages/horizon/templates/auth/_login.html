...
{% block modal-header %}
  <center>
  FAQ: use before you ask on Facebook:<br><a href="http://openstack.redhat.com/TryStackFAQ">TryStack FAQ</a><br>
  Use this video to get started:<br><a href="http://youtu.be/EPZPzXSypl4">http://youtu.be/EPZPzXSypl4</a><br>
  #trystack on freenode
  <br>&nbsp;<br>
  <a href="{% url 'horizon.facebook.views.login' %}" class="btn btn-primary">Login with Facebook</a>
  <br>&nbsp;<br>- or -<br>&nbsp;<br>
  </center>
